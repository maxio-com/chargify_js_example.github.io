  ...
  fetchPreview: function() {
    ...
    fetch(`${serverHost}/surcharging/preview`, {
      ...
      .then(data => {
        ...
        if (percentage > 0) {
          el.textContent = `A surcharge of ${data.formatted_amount} (${percentage}%) will be applied. All future payments made with this card will incur a ${data.percentage}% surcharge.`;
